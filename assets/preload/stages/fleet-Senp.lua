...
function onCreate()
	...
	makeAnimatedLuaSprite('EvilSchool', 'bg/animatedEvilSchool', -1080, -1220)
	addAnimationByPrefix('EvilSchool', 'idle', 'background 2 instance', 16, true)
	setScrollFactor('EvilSchool', 0.9, 1.0);
	scaleObject('EvilSchool', 6.5, 6.5)

		makeLuaSprite('School', 'bg/School', -400, -90);
	setLuaSpriteScrollFactor('School', 1.0, 1.0);
	scaleObject('School', 6.5, 6.5);
	...
	addCharacterToList('ogbf-pixel', 'boyfriend')
	precacheSound('stat')

	setPropertyFromClass('GameOverSubstate', 'characterName', 'Softbf-dead')
end
...
function fleetON()
	...
	playSound('stat', 0.3)
	triggerEvent('Change Character', 0, 'SenpSpirit-play')
...
function fleetOFF()
	...
	doTweenAlpha('fleetON', 'fx', 0, 1, 'linear')
	playSound('stat', 0.3)
	triggerEvent('Change Character', 0, 'Senpai-play')
